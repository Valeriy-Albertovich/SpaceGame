...
maintheme_snd = 'src/sounds/maintheme.mp3'
maintheme_snd = pygame.mixer.Sound(maintheme_snd)
hit_snd = 'src/sounds/hit.mp3'
hit_snd = pygame.mixer.Sound(hit_snd)
exp_snd = 'src/sounds/enemy_dead.mp3'
exp_snd = pygame.mixer.Sound(exp_snd)
shoot1_snd = 'src/sounds/shoot1.mp3'
...
health_bar = 'src/sprites/ui/health.png'
health_bar = pygame.image.load(health_bar)

score_bar = 'src/sprites/ui/time.png'
score_bar = pygame.image.load(score_bar)

player_idle_img = 'src/sprites/player/player1.png'
player_idle_img = pygame.image.load(player_idle_img)
player_left_img = 'src/sprites/player/player_left.png'
player_left_img = pygame.image.load(player_left_img)
player_right_img = 'src/sprites/player/player_right.png'
player_right_img = pygame.image.load(player_right_img)

play_btn = 'src/sprites/ui/play.png'
play_btn = pygame.image.load(play_btn)
pause_btn = 'src/sprites/ui/pause.png'
pause_btn = pygame.image.load(pause_btn)

bullet_yellow = 'src/sprites/weapons/bullet_yellow.png'
bullet_yellow = pygame.image.load(bullet_yellow)

bullet_laser = 'src/sprites/weapons/laser.png'
bullet_laser = pygame.image.load(bullet_laser)

bullet_enemy = 'src/sprites/weapons/bullet_enemy.png'
...
for i in range(1, 6):
    x = 'src/sprites/red/red' + str(i) + '.png'
    x = pygame.image.load(x)
    red_sprites.append(x)
for i in range(1, 11):
    x = 'src/sprites/meteors/meteor' + str(i) + '.png'
    x = pygame.image.load(x)
    meteors_sprite.append(x)

enemy1_img = 'src/sprites/enemies/enemy1.png'
enemy1_img = pygame.image.load(enemy1_img)

enemy2_img = 'src/sprites/enemies/enemy2.png'
enemy2_img = pygame.image.load(enemy2_img)

enemy3_img = 'src/sprites/enemies/enemy3.png'
